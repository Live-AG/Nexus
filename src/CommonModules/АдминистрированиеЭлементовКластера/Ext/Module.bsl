...
Функция ПолучитьАдиминистрированиеКластера(Кластер, Отказ = Ложь) Экспорт
	...
	АгентАдминистрирования = АдминистрированиеЭлементовКластераПовтИсп.ПолучитьАгентаАдминистрированияКластера(Кластер, Отказ);
	Если Отказ Тогда
...
Функция ПолучитьАдминистрированиеИнформационнойБазы(ИнформационнаяБаза, Отказ = Ложь) Экспорт
	...
	Возврат АдминистрированиеЭлементовКластераПовтИсп.ПолучитьАдминистрированиеИнформационнойБазы(ИнформационнаяБаза, Отказ);
...
Функция ПолучитьТаблицуАктивныхСеансовКластера(Кластер, ТаблицаСеансов = Неопределено) Экспорт
	...
	Отказ = Ложь;
	ЭлементАдминистрированиеКластера = АдминистрированиеЭлементовКластераПовтИсп.ПолучитьАдиминистрированиеКластера(Кластер, Отказ);
	Если Отказ Тогда
		Возврат ТаблицаСеансов;		
	КонецЕсли;	
...
Функция ПолучитьТаблицуСеансовИнформационнойБазы(ИнформационнаяБаза) Экспорт
	...
	Отказ = Ложь;
	Адимнистрирование_ИнформационнаяБаза = АдминистрированиеЭлементовКластераПовтИсп.ПолучитьАдминистрированиеИнформационнойБазы(ИнформационнаяБаза, Отказ);
	СеансыИнформационнойБазы = Адимнистрирование_ИнформационнаяБаза.ПолучитьСеансы();
