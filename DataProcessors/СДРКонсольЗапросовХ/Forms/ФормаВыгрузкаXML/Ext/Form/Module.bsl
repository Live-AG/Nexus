...
Процедура _ВыгрузитьДанные(Команда)
	...
	пСтрук.Вставить("Режим", "Выгрузка");
	...
	пСтрук.Вставить("ВыгружатьДвиженияДокументов", _ВыгружатьДвиженияДокументов);
	пСтрук.Вставить("ВыгружатьТекущуюКолонку", _ВыгружатьТекущуюКолонку);
	пСтрук.Вставить("ВыгружатьТолькоВыделенныеСтроки", _ВыгружатьТолькоВыделенныеСтроки);
