...
Процедура НачатьРегистрациюБазКластера()
	...
	ИдентификаторЗадания = ДлительныеОперации.ВыполнитьПроцедуру(ПараметрыВыполнения, 
	...
	ЗаписьТекущегоЗадания.Объект				= Объект.Ссылка; 
	ЗаписьТекущегоЗадания.ИдентификаторЗадания	= ИдентификаторЗадания;  
