...
Процедура ЗаполнитьРеквизитыКластера(Объект, Кластер)
	...
	ЭлементАдминистрированияКластера = АдминистрированиеЭлементовКластера.ПолучитьАдиминистрированиеКластера(Объект);
...
Процедура ПолучитьДанныеАдминистрированиеСервера(Отказ)
	...
	СтруктураПараметров = АдминистрированиеЭлементовКластера.ПолучитьСтруктуруПараметруКластера();

	ЗаполнитьЗначенияСвойств(СтруктураПараметров, Объект);

	АгентАдминистрирования = АдминистрированиеЭлементовКластераПовтИсп.ПолучитьАгентаАдминистрированияКластера(СтруктураПараметров, Отказ);
...
Процедура ЗаполнитьСписокБаз()
	...
	СписокБаз.Очистить();
 	БазыКластера = АдминистрированиеЭлементовКластера.ПолучитьБазыКластера(Объект); 
