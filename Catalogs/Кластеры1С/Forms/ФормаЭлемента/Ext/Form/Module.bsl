...
Процедура НачатьРегистрациюБазКластера()
	...
	//Записать();
	//
	//НачатьРегистрациюБазКластера(Кластер);
	//
	//НачатьРегистрациюБазКластера(Объект.Ссылка);
	//
...
Функция ПолучитьИдентификаторНаСервере()
	...
	ПараметрыКластера = АдминистрированиеЭлементовКластера.ПолучитьПараметрыКластера(Объект);
