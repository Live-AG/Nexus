...
Процедура СоздатьБазыПоДаннымКластера(Кластер)
	...
	Для Каждого АдминистрированиеБазыДанных Из ПараметрыКластера.ИнформационныеБазы Цикл
		...
		АдминистрированиеБазыДанных.ПользовательБазыДанных = "Admin"; 
		АдминистрированиеБазыДанных.ПарольПользователяБазыДанных = "";
		
		АдминистрированиеБазыДанных.ВыполнитьАутентификацию("Admin", "");
