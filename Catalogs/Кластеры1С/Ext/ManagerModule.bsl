...
<<<<<<< HEAD
		ПроверкаСостоянияОбъектов.ПроверитьАктуальностьЗарегистрированныхБаз(Кластер, МассивИдентификаторовАктуальныхБаз);
=======
		МониторингСостоянияОбъектов.ПроверитьАктуальностьЗарегистрированныхБаз(Кластер, МассивИдентификаторовАктуальныхБаз);
