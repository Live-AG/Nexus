...
Функция ПолучитьПараметрыКластера(Кластер) Экспорт
	...
	АдминистрированиеКластера = Новый АдминистрированиеСервера(Кластер.АдресСервераАдминистрирования, Кластер.ПортСервераАдминистрирования);
	
	АдминистрированиеКластера.ПолучитьВерсию();
	АдминистрированиеКластера.ПолучитьКластеры();
...
Функция ПолучитьМакетОписанияКластера(Кластер) Экспорт
	...
	МакетСводнойИнформации = Справочники.Серверы1С.ПолучитьМакет("МакетСводнойИнформации");
