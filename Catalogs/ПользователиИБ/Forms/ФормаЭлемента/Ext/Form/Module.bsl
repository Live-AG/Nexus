...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УстановитьФотографию();
		
КонецПроцедуры

&НаСервере
Процедура УстановитьФотографию()
	
	//REF Реализовать возможность полученяия из файла
	...
	Иначе
		Элементы.АдресФотографии.Видимость = Ложь;
	КонецЕсли;
...
&НаКлиенте
Процедура АдресФотографииПриНажатии(Элемент, ДанныеСобытия, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	ОткрытьФорму("Справочник.ПользователиИБ.Форма.ФормаПросмотраФотографии", 
				Новый Структура("URLФотографии", Объект.URLФотографии), 
				Элемент, 
				ЭтотОбъект, 
				, 
				, 
