...
Функция ПолучитьСведенияОКонфигурации(ИнформационнаяБаза) Экспорт
	...
	ПутьКВременнымДаннымБазы = АдминистрированиеЭлементовКластера.ПолучитьКаталогВременныхФайловБазы(ИнформационнаяБаза);
...
Функция ПолучитьТаблицуПользователей(ИнформационнаяБаза) Экспорт
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |	ВТ_ПользователиИБ.ПользовательИБ КАК ПользовательИБ
	               |ИЗ
	...
	ТаблицаСеансов = АдминистрированиеЭлементовКластера.ПолучитьТаблицуСеансовИнформационнойБазы(ИнформационнаяБаза);
