...
&НаКлиенте
Процедура ДекорацияВерсияКонфигурацииНеЗаполненоНажатие(Элемент)
	
  	ОткрытьФорму("Справочник.ИнформационныеБазы.Форма.ФормаПолученияКонфигурации",  
  					Новый Структура("ОткрытьДляВыбора", Истина), );
...
Процедура УстановитьОтображениеНезаполненныхЭлементов()
	...
	//МассивПроверяемыхРеквизитов.Добавить("ДатаСоздания");
