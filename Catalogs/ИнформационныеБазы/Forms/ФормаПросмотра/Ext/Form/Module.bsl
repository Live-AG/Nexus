...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ОткрытьФормуАвторизации.Видимость = Ложь;
...
Функция НачатьПолучениеСвойствБазы()
	...
	Результат = ДлительныеОперации.ВыполнитьФункцию(ПараметрыВыполнения, 
												"Справочники.ИнформационныеБазы.ПолучитьСвойстваИнформационнойБазы",
												Объект.Ссылка);
...
Процедура ВыполнитьЗаполнениеСвойствБазы()
	...
	ОповещениеОЗавершении = Новый ОписаниеОповещения("ОбработатьРезультатПолученияСвйоств", ЭтотОбъект);
...
&НаКлиенте
Процедура ОбработатьРезультатПолученияСвйоств(Результат, ДополнительныеПараметры) Экспорт
