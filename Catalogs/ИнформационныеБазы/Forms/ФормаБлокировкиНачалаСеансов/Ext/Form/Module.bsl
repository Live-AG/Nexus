...
Функция УстановитьБлокировкуНачалаСеансовНаСервере()
	...
	СтруктураПараметровБлокировкиБазы = АдминистрированиеЭлементовКластера.ПолучитьСтруктуруПараметорвБлокировкиБазы();
	...
	АдминистрированиеЭлементовКластера.УстановитьБлокировкуНачалаСеансов(Объект.Ссылка, СтруктураПараметровБлокировкиБазы);
