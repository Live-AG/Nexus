...
Процедура ОбрезкаРегистраСтатистикаИспользованияБаз()
	...
	Запрос = Новый Запрос;
	Запрос.Текст = "ВЫБРАТЬ
				|	СтатистикаИспользованияИнформационныхБаз.ПериодДанных КАК ПериодДанных,
				...
				|ГДЕ
				|	СтатистикаИспользованияИнформационныхБаз.ПериодДанных < &ПериодДанных";
