...
Процедура СобратьСтатистикуИспользованияИнформационныхБаз() Экспорт
	...
	ТаблицаСеансов = Неопределено;
	
	Пока Выборка.Следующий() Цикл
		АдминистрированиеСеансов.ПолучитьТаблицуАктивныхСеансовКластера(Выборка.Кластер, ТаблицаСеансов);
	КонецЦикла;
...
Процедура ЗаписатьТаблицуВРегистр(ТаблицаСеансов)
	...
	Запрос.Текст = "ВЫБРАТЬ
				...
				|	ВТ_Сеансы.ИмяПользователя КАК ИмяПользователя,
