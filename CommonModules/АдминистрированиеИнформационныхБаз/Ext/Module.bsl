...
Функция ПолучитьСвойстваИнформационнойБазы(ИнформационнаяБаза) Экспорт
	...
	СтркутураСвойствБазы.Вставить("БлокировкаНачалаСеансов", Адимнистрирование_ИнформационнаяБаза.ВключенаБлокировкаНачалаСеансов);
	...
	СтркутураСвойствБазы.Вставить("СерверБазДанных",	Адимнистрирование_ИнформационнаяБаза.СерверБазДанных);
	СтркутураСвойствБазы.Вставить("СУБД",				Адимнистрирование_ИнформационнаяБаза.СУБД);
